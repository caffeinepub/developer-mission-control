...
export class Backend implements backendInterface {
    ...
    async addProfileLink(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProfileLink(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteProfileLink(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteProfileLink(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllProfileLinks(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllProfileLinks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProfileLink(arg0: string): Promise<string> {
        if (this.processError) {
            try {
